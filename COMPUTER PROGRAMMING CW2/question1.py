...
try:#testing for errors
    ...
    print('btw your birth year is: ', birth_year) # output of the user birth year 
    number=int(input(f'\n {name.upper()} can we know your favourite number: ')) #prompting user input that is an integer
    if (number%2)==0: # incace what the user inputs is divisible by 2 and has no remender 
        ...
        #nested if checking where the nuber lies basing on 10   
        if number<10:
